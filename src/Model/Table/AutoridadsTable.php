 ...
 * @method \App\Model\Entity\Autoridad|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Autoridad findOrCreate($search, callable $callback = null, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class AutoridadsTable extends Table
{
    ...
    public function isOwnedBy($autoridadId, $userId)
    {
        return $this->exists(['id' => $autoridadId, 'user_id' => $userId]);
    }
}
